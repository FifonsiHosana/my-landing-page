...
export default function SkillCount() {
  ...
  return (
    <div className=" max-w-7xl mx-auto overflow-hidden ">
      <div className="container mx-auto mt-20 px-6 md:px-12 overflow-hidden flex ">
        <div className="flex flex-row items-center justify-evenly gap-4 w-full max-sm:flex-col">
